...
|---|---|---|
| REQ-007 | A signed-in shopper places the order held in the cart and receives its identifier. | AC-001 AC-002 AC-003 |
...
Order cancellation, which no story carries yet.
